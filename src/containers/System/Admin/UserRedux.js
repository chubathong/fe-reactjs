...
class UserRedux extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        //render -> didupdate (render xong sẽ chạy vào didupdate)
        //hiện tại và quá khứ
                ...
                <div className="user-redux-body" >
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-3'>
                                <label><FormattedMessage id="manage-user.phoneNumber"
                                /></label>
                                <input className='form-control' type='text'
                                    value={phoneNumber}
...
const mapDispatchToProps = dispatch => {
    return {
        getGenderStart: () => dispatch(actions.fetchGender()),
        getPositionStart: () => dispatch(actions.fetchPosition()),
        getRoleStart: () => dispatch(actions.fetchRole()),
